...
I would have liked to create a stacked bar chart that shows the pollen deposition per flower-day by species however this information was not included in the data I managed to obtain from the author. My second solution was to create a box plot overlaid by a strip chart. 
