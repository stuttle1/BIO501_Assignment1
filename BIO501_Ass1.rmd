...
ggplot(aes(x = reorder(farm_type, -Richness), y = Richness)) +
  ...
  stat_boxplot(aes(farm_type, Richness), 
...
# Converting from character to factor to allow for graphing
watermelon_org$Abundance <- as.factor(watermelon_org$Abundance)
